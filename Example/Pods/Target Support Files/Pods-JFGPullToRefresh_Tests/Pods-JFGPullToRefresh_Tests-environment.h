...
// JFGPullToRefresh
#define COCOAPODS_POD_AVAILABLE_JFGPullToRefresh
#define COCOAPODS_VERSION_MAJOR_JFGPullToRefresh 0
#define COCOAPODS_VERSION_MINOR_JFGPullToRefresh 1
#define COCOAPODS_VERSION_PATCH_JFGPullToRefresh 0
